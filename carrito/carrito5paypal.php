	...
	*/
	...
	if( $ack == "SUCCESS" || $ack == "SUCCESSWITHWARNING" )
	{
		...
		*/
		...
		$pagada_description = $paymentStatus.$pendingReason;
		
		
                
                //guardamos en en una variable de sesion el estado del pedido
                $_SESSION[estadopaypal]=$paymentStatus;
                
                //actualizamos la respuesta de Paypal
                $query = "UPDATE Carrito_Pedidos SET CPobservaciones='$pagada_description' WHERE CPid='$_SESSION[numero_pedido]'";
                $mysqli->query($query);
		
		if($paymentStatus=="Completed"){
			//actualizamos la respuesta de Paypal
                        $query = "UPDATE Carrito_Pedidos SET CPpagado='si' WHERE CPid='$_SESSION[numero_pedido]'";
                        $mysqli->query($query);
		}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $mensaje = '
            ...
            <p>Pagado con Paypal.</p>
        ';
        $comprobacion_email = mailer($email_destino, $nombre_email, $asunto, $mensaje);
              
        if($comprobacion_email==1){
            $_SESSION[errores]="ok";
            $_SESSION[comentario]="Gracias por completar tu pedido. ";
        } 
        
        
        
        header('Location: '.$INC_url.'/carrito/carrito_terminado_paypal');
?>
