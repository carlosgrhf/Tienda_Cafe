...
<div id="contenedor">
    ...
    echo '<div style="float:left; width: 315px; height: 250px; background: #382E2A; padding-left:20px; padding-top: 18px; margin-top:20px; margin-left:20px; color: #fff;">
      ...
      <ul class=lista_carrito_paso_dos>
        <li>Forma elegida: Paypal</li>
        <li>Respuesta de Paypal: '.$_SESSION[estadopaypal].'</li>
      </ul><br /></div>
    ';    
...
<!-- Google Code for Agradecimiento Conversion Page -->
<img height="1" width="1" alt="" src="http://www.googleadservices.com/pagead/conversion/998920654/imp.gif?value=50&amp;label=pE7BCILLugYQzqOp3AM&amp;guid=ON&amp;script=0"/>            
</body>
</html>