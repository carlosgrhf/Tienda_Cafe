...
<head>
	...
	<meta name="Description" content="<?php echo $cat; ?> - <?php echo $INC_descripcion; ?>" />
        <meta name="author" content="Hay Canal Web S.L." />
	<meta name="Language" content="es" />
	<meta name="Robots" content="index, follow" />
	<title><?php echo $INC_titulo; ?> - <?php echo $cat; ?></title>
...
<div id="contenedor">    
    ...
    //semillas
    echo '<br /><p style="font-size:12pt;">'.$cat.' ></p>';
    ...
    //consultamos en la base de datos 
    $sql = "SELECT * FROM Productos WHERE Pfamilia='$cat_sin' AND Pdesactivar='no'";
    if(!$result = $mysqli->query($sql)){
        die("Query invalido: " . $sql);
    }
    /* fetch array asociativo*/
