...
<head>
	...
	<meta name="Description" content="Noticias - <?php echo $INC_descripcion; ?>" />
        <meta name="author" content="Hay Canal Web S.L." />
	<meta name="Language" content="es" />
	<meta name="Robots" content="index, follow" />
	<title><?php echo $INC_titulo; ?> - Noticias</title>
...
<div id="contenedor"> 
    ...
    <div id="central_producto"> 
        ...
        <p style="font-size:12pt;">
            <a href="<?php echo $INC_url; ?>" title="Café en Capsulas">Inicio</a> > 
            Noticias</p>
    <?php
    ...
    $cantidadEnlaces            = 15; // Cantidad de enlaces que tendra el paginador.
    ...
    while ($fila = $result->fetch_assoc()) {
        ...
        echo '
            <div class="noticias">
                <h2><a href="'.$INC_url.'/noticia/'.$Nid.'/'.$Ntitulo_arreglado.'" title="'.$Ntitulo.'">'.$Ntitulo.'</a></h2>
                <div style="float:left; margin-right:1%;">                    
                    <a href="'.$INC_url.'/noticia/'.$Nid.'/'.$Ntitulo_arreglado.'" title="'.$Ntitulo.'">
                        <img src="'.$INC_url.'/img/news/'.$Nimagenuno.'" alt="'.$Ntitulo.'" />
                    </a>
                </div>
                <p>'.$Nfecha.'</p>
                '.$Ndescripcion.'
