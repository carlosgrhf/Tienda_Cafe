...
if($_SESSION[errores]=="ok"){
    ...
    <div id="flotante" class="errores_ok">
        ...
        <a href="javascript:cerrar();">
            <img style="float:right; margin-right: 10px;" src="'.$INC_url.'/img/iconos/blacks/32x32/round_delete.png">
        </a>
    </div>
    ';
}
if($_SESSION[errores]=="error"){
    ...
    <div id="flotante" class="errores_error">
        ...
        <p>Mensaje: '.$comentario.'</p>
        <a href="javascript:cerrar();">
            <img style="float:right; margin-right: 10px;" src="'.$INC_url.'/img/iconos/white/32x32/round_delete.png">
        </a>
    </div>
    ';
}
